...
if __name__ == '__main__':
	...
	ax=plt.subplot(111)
	kmf2 = kaplanMeier(T1,C1)
	kmf1 = kaplanMeier(T2,C2)
	PVALUE = results.p_value
	kmf1.plot(ax=ax,label="Both genes mutated in tumor")
	kmf2.plot(ax=ax,label="Both genes no mutated in tumor")
	plt.ylim(0,1)
	plt.xlim(0,3000)
	plt.title("Survival of both genes mutated in tumor against no mutation at all")
#        plotKaplan(T1,"both")
